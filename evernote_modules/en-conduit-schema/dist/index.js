...
var EntityLocalStateFilterField;
(function (EntityLocalStateFilterField) {
    EntityLocalStateFilterField["Id"] = "id";
    EntityLocalStateFilterField["ExpandedFields"] = "expandedFields";
    EntityLocalStateFilterField["Label"] = "label";
})(EntityLocalStateFilterField = exports.EntityLocalStateFilterField || (exports.EntityLocalStateFilterField = {}));
var EntityLocalStateSortField;
(function (EntityLocalStateSortField) {
    EntityLocalStateSortField["Id"] = "id";
    EntityLocalStateSortField["ExpandedFields"] = "expandedFields";
    EntityLocalStateSortField["Label"] = "label";
})(EntityLocalStateSortField = exports.EntityLocalStateSortField || (exports.EntityLocalStateSortField = {}));
...
var GamificationGoalFilterField;
(function (GamificationGoalFilterField) {
    GamificationGoalFilterField["Id"] = "id";
    GamificationGoalFilterField["GoalType"] = "goalType";
    GamificationGoalFilterField["Level"] = "level";
    GamificationGoalFilterField["Created"] = "created";
    GamificationGoalFilterField["Updated"] = "updated";
    GamificationGoalFilterField["Label"] = "label";
})(GamificationGoalFilterField = exports.GamificationGoalFilterField || (exports.GamificationGoalFilterField = {}));
var GamificationGoalSortField;
(function (GamificationGoalSortField) {
    GamificationGoalSortField["Id"] = "id";
    GamificationGoalSortField["GoalType"] = "goalType";
    GamificationGoalSortField["Level"] = "level";
    GamificationGoalSortField["Created"] = "created";
    GamificationGoalSortField["Updated"] = "updated";
    GamificationGoalSortField["Label"] = "label";
})(GamificationGoalSortField = exports.GamificationGoalSortField || (exports.GamificationGoalSortField = {}));
var GamificationMilestoneFilterField;
(function (GamificationMilestoneFilterField) {
    GamificationMilestoneFilterField["Id"] = "id";
    GamificationMilestoneFilterField["MilestoneKey"] = "milestoneKey";
    GamificationMilestoneFilterField["Complete"] = "complete";
    GamificationMilestoneFilterField["Progress"] = "progress";
    GamificationMilestoneFilterField["Created"] = "created";
    GamificationMilestoneFilterField["Updated"] = "updated";
    GamificationMilestoneFilterField["Label"] = "label";
})(GamificationMilestoneFilterField = exports.GamificationMilestoneFilterField || (exports.GamificationMilestoneFilterField = {}));
var GamificationMilestoneSortField;
(function (GamificationMilestoneSortField) {
    GamificationMilestoneSortField["Id"] = "id";
    GamificationMilestoneSortField["MilestoneKey"] = "milestoneKey";
    GamificationMilestoneSortField["Complete"] = "complete";
    GamificationMilestoneSortField["Progress"] = "progress";
    GamificationMilestoneSortField["Created"] = "created";
    GamificationMilestoneSortField["Updated"] = "updated";
    GamificationMilestoneSortField["Label"] = "label";
})(GamificationMilestoneSortField = exports.GamificationMilestoneSortField || (exports.GamificationMilestoneSortField = {}));
var GamificationSummaryFilterField;
(function (GamificationSummaryFilterField) {
    GamificationSummaryFilterField["Id"] = "id";
    GamificationSummaryFilterField["SelectedGoalType"] = "selectedGoalType";
    GamificationSummaryFilterField["Created"] = "created";
    GamificationSummaryFilterField["Updated"] = "updated";
    GamificationSummaryFilterField["Label"] = "label";
})(GamificationSummaryFilterField = exports.GamificationSummaryFilterField || (exports.GamificationSummaryFilterField = {}));
var GamificationSummarySortField;
(function (GamificationSummarySortField) {
    GamificationSummarySortField["Id"] = "id";
    GamificationSummarySortField["SelectedGoalType"] = "selectedGoalType";
    GamificationSummarySortField["Created"] = "created";
    GamificationSummarySortField["Updated"] = "updated";
    GamificationSummarySortField["Label"] = "label";
})(GamificationSummarySortField = exports.GamificationSummarySortField || (exports.GamificationSummarySortField = {}));
...
var NoteDescendentTasksOrderBy;
(function (NoteDescendentTasksOrderBy) {
    NoteDescendentTasksOrderBy["SortWeight"] = "sortWeight";
    NoteDescendentTasksOrderBy["SortWeightCompletedAtBottom"] = "sortWeightCompletedAtBottom";
})(NoteDescendentTasksOrderBy = exports.NoteDescendentTasksOrderBy || (exports.NoteDescendentTasksOrderBy = {}));
var NoteFilterField;
(function (NoteFilterField) {
    ...
    NoteFilterField["IsShared"] = "isShared";
    NoteFilterField["IsDefaultTaskNote"] = "isDefaultTaskNote";
    NoteFilterField["TasksCount"] = "tasksCount";
    NoteFilterField["InBusinessAccount"] = "inBusinessAccount";
    NoteFilterField["HasTaskGroup"] = "hasTaskGroup";
    NoteFilterField["HasCompletedAllTasks"] = "hasCompletedAllTasks";
...
(function (NotesInTrashOrderBy) {
    ...
    NotesInTrashOrderBy["Deleted"] = "deleted";
...
(function (NoteSortField) {
    ...
    NoteSortField["IsShared"] = "isShared";
    NoteSortField["IsDefaultTaskNote"] = "isDefaultTaskNote";
    NoteSortField["TasksCount"] = "tasksCount";
    NoteSortField["InBusinessAccount"] = "inBusinessAccount";
    NoteSortField["HasTaskGroup"] = "hasTaskGroup";
    NoteSortField["HasCompletedAllTasks"] = "hasCompletedAllTasks";
    NoteSortField["Id"] = "id";
...
var ProfileDescendentTasksOrderBy;
(function (ProfileDescendentTasksOrderBy) {
    ProfileDescendentTasksOrderBy["SortWeight"] = "sortWeight";
    ProfileDescendentTasksOrderBy["SortWeightCompletedAtBottom"] = "sortWeightCompletedAtBottom";
})(ProfileDescendentTasksOrderBy = exports.ProfileDescendentTasksOrderBy || (exports.ProfileDescendentTasksOrderBy = {}));
...
var ProfileTasksOrderBy;
(function (ProfileTasksOrderBy) {
    ProfileTasksOrderBy["DueDate"] = "dueDate";
    ProfileTasksOrderBy["DueDateFlaggedAbove"] = "dueDateFlaggedAbove";
    ProfileTasksOrderBy["DueDateCompletedAtBottom"] = "dueDateCompletedAtBottom";
})(ProfileTasksOrderBy = exports.ProfileTasksOrderBy || (exports.ProfileTasksOrderBy = {}));
var ProfileTasksWithoutNoteOrderBy;
(function (ProfileTasksWithoutNoteOrderBy) {
    ProfileTasksWithoutNoteOrderBy["DueDate"] = "dueDate";
    ProfileTasksWithoutNoteOrderBy["DueDateCompletedAtBottom"] = "dueDateCompletedAtBottom";
    ProfileTasksWithoutNoteOrderBy["SortWeight"] = "sortWeight";
    ProfileTasksWithoutNoteOrderBy["SortWeightCompletedAtBottom"] = "sortWeightCompletedAtBottom";
})(ProfileTasksWithoutNoteOrderBy = exports.ProfileTasksWithoutNoteOrderBy || (exports.ProfileTasksWithoutNoteOrderBy = {}));
...
(function (TaskFilterField) {
    TaskFilterField["Creator"] = "creator";
    TaskFilterField["Parent"] = "parent";
    TaskFilterField["Assignee"] = "assignee";
    TaskFilterField["AssignedBy"] = "assignedBy";
    ...
    TaskFilterField["AssignedToMe"] = "assignedToMe";
    TaskFilterField["HasReminder"] = "hasReminder";
    TaskFilterField["InTrash"] = "inTrash";
    TaskFilterField["ContentInfo"] = "contentInfo";
    TaskFilterField["HasNote"] = "hasNote";
...
(function (TaskNotesNotInTrashOrderBy) {
    ...
    TaskNotesNotInTrashOrderBy["LabelCompletedAtBottom"] = "labelCompletedAtBottom";
    TaskNotesNotInTrashOrderBy["LabelDtnPinned"] = "labelDTNPinned";
    TaskNotesNotInTrashOrderBy["LabelDtnPinnedCompletedAtBottom"] = "labelDTNPinnedCompletedAtBottom";
    TaskNotesNotInTrashOrderBy["Created"] = "created";
    TaskNotesNotInTrashOrderBy["CreatedCompletedAtBottom"] = "createdCompletedAtBottom";
    TaskNotesNotInTrashOrderBy["CreatedDtnPinned"] = "createdDTNPinned";
    TaskNotesNotInTrashOrderBy["CreatedDtnPinnedCompletedAtBottom"] = "createdDTNPinnedCompletedAtBottom";
    TaskNotesNotInTrashOrderBy["Updated"] = "updated";
    TaskNotesNotInTrashOrderBy["UpdatedCompletedAtBottom"] = "updatedCompletedAtBottom";
    TaskNotesNotInTrashOrderBy["UpdatedDtnPinned"] = "updatedDTNPinned";
    TaskNotesNotInTrashOrderBy["UpdatedDtnPinnedCompletedAtBottom"] = "updatedDTNPinnedCompletedAtBottom";
})(TaskNotesNotInTrashOrderBy = exports.TaskNotesNotInTrashOrderBy || (exports.TaskNotesNotInTrashOrderBy = {}));
var TaskNotesSort;
(function (TaskNotesSort) {
    TaskNotesSort["Label"] = "label";
    TaskNotesSort["Updated"] = "updated";
    TaskNotesSort["Created"] = "created";
})(TaskNotesSort = exports.TaskNotesSort || (exports.TaskNotesSort = {}));
...
var TasksInNoteOrderBy;
(function (TasksInNoteOrderBy) {
    TasksInNoteOrderBy["SortWeight"] = "sortWeight";
    TasksInNoteOrderBy["SortWeightCompletedAtBottom"] = "sortWeightCompletedAtBottom";
})(TasksInNoteOrderBy = exports.TasksInNoteOrderBy || (exports.TasksInNoteOrderBy = {}));
var TasksOrderBy;
(function (TasksOrderBy) {
    TasksOrderBy["DueDate"] = "dueDate";
    TasksOrderBy["DueDateFlaggedAbove"] = "dueDateFlaggedAbove";
    TasksOrderBy["DueDateCompletedAtBottom"] = "dueDateCompletedAtBottom";
})(TasksOrderBy = exports.TasksOrderBy || (exports.TasksOrderBy = {}));
var TaskSortField;
(function (TaskSortField) {
    TaskSortField["Creator"] = "creator";
    TaskSortField["Parent"] = "parent";
    TaskSortField["Assignee"] = "assignee";
    TaskSortField["AssignedBy"] = "assignedBy";
    ...
    TaskSortField["AssignedToMe"] = "assignedToMe";
    TaskSortField["HasReminder"] = "hasReminder";
    TaskSortField["InTrash"] = "inTrash";
    TaskSortField["ContentInfo"] = "contentInfo";
    TaskSortField["HasNote"] = "hasNote";
    TaskSortField["Id"] = "id";
...
var TasksWithoutNoteOrderBy;
(function (TasksWithoutNoteOrderBy) {
    TasksWithoutNoteOrderBy["DueDate"] = "dueDate";
    TasksWithoutNoteOrderBy["DueDateCompletedAtBottom"] = "dueDateCompletedAtBottom";
    TasksWithoutNoteOrderBy["SortWeight"] = "sortWeight";
    TasksWithoutNoteOrderBy["SortWeightCompletedAtBottom"] = "sortWeightCompletedAtBottom";
})(TasksWithoutNoteOrderBy = exports.TasksWithoutNoteOrderBy || (exports.TasksWithoutNoteOrderBy = {}));
...
(function (TokenTypeString) {
    TokenTypeString["InAppBoronLinux"] = "IN_APP_BORON_LINUX";
    TokenTypeString["InAppBoronMac"] = "IN_APP_BORON_MAC";
    TokenTypeString["InAppBoronWin"] = "IN_APP_BORON_WIN";
    TokenTypeString["InAppIon"] = "IN_APP_ION";
    TokenTypeString["MobileDefault"] = "MOBILE_DEFAULT";
    TokenTypeString["MobileNeutronAndroid"] = "MOBILE_NEUTRON_ANDROID";
    TokenTypeString["MobileNeutronIos"] = "MOBILE_NEUTRON_IOS";
    TokenTypeString["PushBoronLinux"] = "PUSH_BORON_LINUX";
    TokenTypeString["PushBoronMac"] = "PUSH_BORON_MAC";
    TokenTypeString["PushBoronWin"] = "PUSH_BORON_WIN";
    TokenTypeString["PushIon"] = "PUSH_ION";
})(TokenTypeString = exports.TokenTypeString || (exports.TokenTypeString = {}));
var TsdType;
(function (TsdType) {
...
(function (UserFilterField) {
    UserFilterField["Profile"] = "profile";
    UserFilterField["Id"] = "id";
    UserFilterField["IsVaultUser"] = "isVaultUser";
    UserFilterField["Username"] = "username";
    UserFilterField["Email"] = "email";
    UserFilterField["Name"] = "name";
    UserFilterField["Timezone"] = "timezone";
    UserFilterField["Privilege"] = "privilege";
    UserFilterField["ServiceLevel"] = "serviceLevel";
    UserFilterField["ServiceLevelV2"] = "serviceLevelV2";
    UserFilterField["Created"] = "created";
    UserFilterField["Updated"] = "updated";
    UserFilterField["Deleted"] = "deleted";
    UserFilterField["Active"] = "active";
    UserFilterField["PhotoUrl"] = "photoUrl";
    UserFilterField["PhotoLastUpdated"] = "photoLastUpdated";
    UserFilterField["BusinessUserRole"] = "businessUserRole";
    UserFilterField["BusinessName"] = "businessName";
    UserFilterField["AccountingUploadLimit"] = "Accounting_uploadLimit";
    UserFilterField["AccountingUploadLimitEnd"] = "Accounting_uploadLimitEnd";
    UserFilterField["AccountingUploadLimitNextMonth"] = "Accounting_uploadLimitNextMonth";
    UserFilterField["AccountingPremiumServiceStatus"] = "Accounting_premiumServiceStatus";
    UserFilterField["AccountingPremiumOrderNumber"] = "Accounting_premiumOrderNumber";
    UserFilterField["AccountingPremiumCommerceService"] = "Accounting_premiumCommerceService";
    UserFilterField["AccountingPremiumServiceStart"] = "Accounting_premiumServiceStart";
    UserFilterField["AccountingPremiumServiceSku"] = "Accounting_premiumServiceSKU";
    UserFilterField["AccountingLastSuccessfulCharge"] = "Accounting_lastSuccessfulCharge";
    UserFilterField["AccountingLastFailedCharge"] = "Accounting_lastFailedCharge";
    UserFilterField["AccountingLastFailedChargeReason"] = "Accounting_lastFailedChargeReason";
    UserFilterField["AccountingNextPaymentDue"] = "Accounting_nextPaymentDue";
    UserFilterField["AccountingPremiumLockUntil"] = "Accounting_premiumLockUntil";
    UserFilterField["AccountingUpdated"] = "Accounting_updated";
    UserFilterField["AccountingPremiumSubscriptionNumber"] = "Accounting_premiumSubscriptionNumber";
    UserFilterField["AccountingLastRequestedCharge"] = "Accounting_lastRequestedCharge";
    UserFilterField["AccountingCurrency"] = "Accounting_currency";
    UserFilterField["AccountingUnitPrice"] = "Accounting_unitPrice";
    UserFilterField["AccountingBusinessId"] = "Accounting_businessId";
    UserFilterField["AccountingBusinessName"] = "Accounting_businessName";
    UserFilterField["AccountingBusinessRole"] = "Accounting_businessRole";
    UserFilterField["AccountingUnitDiscount"] = "Accounting_unitDiscount";
    UserFilterField["AccountingNextChargeDate"] = "Accounting_nextChargeDate";
    UserFilterField["AccountingAvailablePoints"] = "Accounting_availablePoints";
    UserFilterField["AccountingBackupPaymentInfoPremiumCommerceService"] = "Accounting_backupPaymentInfo_premiumCommerceService";
    UserFilterField["AccountingBackupPaymentInfoPremiumServiceSku"] = "Accounting_backupPaymentInfo_premiumServiceSKU";
    UserFilterField["AccountingBackupPaymentInfoCurrency"] = "Accounting_backupPaymentInfo_currency";
    UserFilterField["AccountingBackupPaymentInfoUnitPrice"] = "Accounting_backupPaymentInfo_unitPrice";
    UserFilterField["AccountingBackupPaymentInfoPaymentMethodId"] = "Accounting_backupPaymentInfo_paymentMethodId";
    UserFilterField["AccountingBackupPaymentInfoOrderNumber"] = "Accounting_backupPaymentInfo_orderNumber";
    UserFilterField["AttributesPreferredLanguage"] = "Attributes_preferredLanguage";
    UserFilterField["AttributesEmailAddressLastConfirmed"] = "Attributes_emailAddressLastConfirmed";
    UserFilterField["AttributesPasswordUpdated"] = "Attributes_passwordUpdated";
    UserFilterField["AttributesIncomingEmailAddress"] = "Attributes_incomingEmailAddress";
    UserFilterField["AttributesReminderEmail"] = "Attributes_reminderEmail";
    UserFilterField["CanEmptyTrash"] = "canEmptyTrash";
    UserFilterField["SubscriptionInfoUpdatedTime"] = "subscriptionInfo_updatedTime";
    UserFilterField["SubscriptionInfoIsSubscribed"] = "subscriptionInfo_isSubscribed";
    UserFilterField["SubscriptionInfoSubscriptionRecurring"] = "subscriptionInfo_subscriptionRecurring";
    UserFilterField["SubscriptionInfoSubscriptionExpirationDate"] = "subscriptionInfo_subscriptionExpirationDate";
    UserFilterField["SubscriptionInfoSubscriptionPending"] = "subscriptionInfo_subscriptionPending";
    UserFilterField["SubscriptionInfoSubscriptionCancellationPending"] = "subscriptionInfo_subscriptionCancellationPending";
    UserFilterField["SubscriptionInfoServiceLevelsEligibleForPurchase"] = "subscriptionInfo_serviceLevelsEligibleForPurchase";
    UserFilterField["SubscriptionInfoCurrentSku"] = "subscriptionInfo_currentSku";
    UserFilterField["SubscriptionInfoValidUntil"] = "subscriptionInfo_validUntil";
    UserFilterField["SubscriptionInfoItunesReceiptRequested"] = "subscriptionInfo_itunesReceiptRequested";
    UserFilterField["Label"] = "label";
})(UserFilterField = exports.UserFilterField || (exports.UserFilterField = {}));
...
(function (UserSortField) {
    UserSortField["Profile"] = "profile";
    UserSortField["Id"] = "id";
    UserSortField["IsVaultUser"] = "isVaultUser";
    UserSortField["Username"] = "username";
    UserSortField["Email"] = "email";
    UserSortField["Name"] = "name";
    UserSortField["Timezone"] = "timezone";
    UserSortField["Privilege"] = "privilege";
    UserSortField["ServiceLevel"] = "serviceLevel";
    UserSortField["ServiceLevelV2"] = "serviceLevelV2";
    UserSortField["Created"] = "created";
    UserSortField["Updated"] = "updated";
    UserSortField["Deleted"] = "deleted";
    UserSortField["Active"] = "active";
    UserSortField["PhotoUrl"] = "photoUrl";
    UserSortField["PhotoLastUpdated"] = "photoLastUpdated";
    UserSortField["BusinessUserRole"] = "businessUserRole";
    UserSortField["BusinessName"] = "businessName";
    UserSortField["AccountingUploadLimit"] = "Accounting_uploadLimit";
    UserSortField["AccountingUploadLimitEnd"] = "Accounting_uploadLimitEnd";
    UserSortField["AccountingUploadLimitNextMonth"] = "Accounting_uploadLimitNextMonth";
    UserSortField["AccountingPremiumServiceStatus"] = "Accounting_premiumServiceStatus";
    UserSortField["AccountingPremiumOrderNumber"] = "Accounting_premiumOrderNumber";
    UserSortField["AccountingPremiumCommerceService"] = "Accounting_premiumCommerceService";
    UserSortField["AccountingPremiumServiceStart"] = "Accounting_premiumServiceStart";
    UserSortField["AccountingPremiumServiceSku"] = "Accounting_premiumServiceSKU";
    UserSortField["AccountingLastSuccessfulCharge"] = "Accounting_lastSuccessfulCharge";
    UserSortField["AccountingLastFailedCharge"] = "Accounting_lastFailedCharge";
    UserSortField["AccountingLastFailedChargeReason"] = "Accounting_lastFailedChargeReason";
    UserSortField["AccountingNextPaymentDue"] = "Accounting_nextPaymentDue";
    UserSortField["AccountingPremiumLockUntil"] = "Accounting_premiumLockUntil";
    UserSortField["AccountingUpdated"] = "Accounting_updated";
    UserSortField["AccountingPremiumSubscriptionNumber"] = "Accounting_premiumSubscriptionNumber";
    UserSortField["AccountingLastRequestedCharge"] = "Accounting_lastRequestedCharge";
    UserSortField["AccountingCurrency"] = "Accounting_currency";
    UserSortField["AccountingUnitPrice"] = "Accounting_unitPrice";
    UserSortField["AccountingBusinessId"] = "Accounting_businessId";
    UserSortField["AccountingBusinessName"] = "Accounting_businessName";
    UserSortField["AccountingBusinessRole"] = "Accounting_businessRole";
    UserSortField["AccountingUnitDiscount"] = "Accounting_unitDiscount";
    UserSortField["AccountingNextChargeDate"] = "Accounting_nextChargeDate";
    UserSortField["AccountingAvailablePoints"] = "Accounting_availablePoints";
    UserSortField["AccountingBackupPaymentInfoPremiumCommerceService"] = "Accounting_backupPaymentInfo_premiumCommerceService";
    UserSortField["AccountingBackupPaymentInfoPremiumServiceSku"] = "Accounting_backupPaymentInfo_premiumServiceSKU";
    UserSortField["AccountingBackupPaymentInfoCurrency"] = "Accounting_backupPaymentInfo_currency";
    UserSortField["AccountingBackupPaymentInfoUnitPrice"] = "Accounting_backupPaymentInfo_unitPrice";
    UserSortField["AccountingBackupPaymentInfoPaymentMethodId"] = "Accounting_backupPaymentInfo_paymentMethodId";
    UserSortField["AccountingBackupPaymentInfoOrderNumber"] = "Accounting_backupPaymentInfo_orderNumber";
    UserSortField["AttributesPreferredLanguage"] = "Attributes_preferredLanguage";
    UserSortField["AttributesEmailAddressLastConfirmed"] = "Attributes_emailAddressLastConfirmed";
    UserSortField["AttributesPasswordUpdated"] = "Attributes_passwordUpdated";
    UserSortField["AttributesIncomingEmailAddress"] = "Attributes_incomingEmailAddress";
    UserSortField["AttributesReminderEmail"] = "Attributes_reminderEmail";
    UserSortField["CanEmptyTrash"] = "canEmptyTrash";
    UserSortField["SubscriptionInfoUpdatedTime"] = "subscriptionInfo_updatedTime";
    UserSortField["SubscriptionInfoIsSubscribed"] = "subscriptionInfo_isSubscribed";
    UserSortField["SubscriptionInfoSubscriptionRecurring"] = "subscriptionInfo_subscriptionRecurring";
    UserSortField["SubscriptionInfoSubscriptionExpirationDate"] = "subscriptionInfo_subscriptionExpirationDate";
    UserSortField["SubscriptionInfoSubscriptionPending"] = "subscriptionInfo_subscriptionPending";
    UserSortField["SubscriptionInfoSubscriptionCancellationPending"] = "subscriptionInfo_subscriptionCancellationPending";
    UserSortField["SubscriptionInfoServiceLevelsEligibleForPurchase"] = "subscriptionInfo_serviceLevelsEligibleForPurchase";
    UserSortField["SubscriptionInfoCurrentSku"] = "subscriptionInfo_currentSku";
    UserSortField["SubscriptionInfoValidUntil"] = "subscriptionInfo_validUntil";
    UserSortField["SubscriptionInfoItunesReceiptRequested"] = "subscriptionInfo_itunesReceiptRequested";
    UserSortField["Label"] = "label";
...
var WidgetCustomizeEntityTypesInput;
(function (WidgetCustomizeEntityTypesInput) {
    WidgetCustomizeEntityTypesInput["Note"] = "Note";
    WidgetCustomizeEntityTypesInput["Notebook"] = "Notebook";
    WidgetCustomizeEntityTypesInput["Workspace"] = "Workspace";
    WidgetCustomizeEntityTypesInput["Attachment"] = "Attachment";
    WidgetCustomizeEntityTypesInput["Tag"] = "Tag";
    WidgetCustomizeEntityTypesInput["SavedSearch"] = "SavedSearch";
    WidgetCustomizeEntityTypesInput["Shortcut"] = "Shortcut";
    WidgetCustomizeEntityTypesInput["Board"] = "Board";
    WidgetCustomizeEntityTypesInput["Widget"] = "Widget";
    WidgetCustomizeEntityTypesInput["WidgetContentConflict"] = "WidgetContentConflict";
    WidgetCustomizeEntityTypesInput["ScheduledNotification"] = "ScheduledNotification";
    WidgetCustomizeEntityTypesInput["NoteContentInfo"] = "NoteContentInfo";
    WidgetCustomizeEntityTypesInput["Reminder"] = "Reminder";
    WidgetCustomizeEntityTypesInput["Task"] = "Task";
    WidgetCustomizeEntityTypesInput["TaskUserSettings"] = "TaskUserSettings";
    WidgetCustomizeEntityTypesInput["GamificationSummary"] = "GamificationSummary";
    WidgetCustomizeEntityTypesInput["GamificationMilestone"] = "GamificationMilestone";
    WidgetCustomizeEntityTypesInput["GamificationGoal"] = "GamificationGoal";
    WidgetCustomizeEntityTypesInput["CalendarSettings"] = "CalendarSettings";
    WidgetCustomizeEntityTypesInput["CalendarAccount"] = "CalendarAccount";
    WidgetCustomizeEntityTypesInput["UserCalendarSettings"] = "UserCalendarSettings";
    WidgetCustomizeEntityTypesInput["CalendarEvent"] = "CalendarEvent";
    WidgetCustomizeEntityTypesInput["ExampleParent"] = "ExampleParent";
    WidgetCustomizeEntityTypesInput["Example"] = "Example";
})(WidgetCustomizeEntityTypesInput = exports.WidgetCustomizeEntityTypesInput || (exports.WidgetCustomizeEntityTypesInput = {}));
var WidgetCustomizeEntryPointTypesInput;
(function (WidgetCustomizeEntryPointTypesInput) {
    WidgetCustomizeEntryPointTypesInput["BannerNewFeature"] = "BANNER_NEW_FEATURE";
    WidgetCustomizeEntryPointTypesInput["BannerOther"] = "BANNER_OTHER";
    WidgetCustomizeEntryPointTypesInput["Create"] = "CREATE";
    WidgetCustomizeEntryPointTypesInput["Customize"] = "CUSTOMIZE";
    WidgetCustomizeEntryPointTypesInput["Editor"] = "EDITOR";
    WidgetCustomizeEntryPointTypesInput["Search"] = "SEARCH";
    WidgetCustomizeEntryPointTypesInput["FeatureTrial"] = "FEATURE_TRIAL";
    WidgetCustomizeEntryPointTypesInput["ResetLayout"] = "RESET_LAYOUT";
    WidgetCustomizeEntryPointTypesInput["MenuContext"] = "MENU_CONTEXT";
    WidgetCustomizeEntryPointTypesInput["MenuEditor"] = "MENU_EDITOR";
    WidgetCustomizeEntryPointTypesInput["MenuNav"] = "MENU_NAV";
    WidgetCustomizeEntryPointTypesInput["MenuOther"] = "MENU_OTHER";
    WidgetCustomizeEntryPointTypesInput["MenuOverflow"] = "MENU_OVERFLOW";
    WidgetCustomizeEntryPointTypesInput["ModalHome"] = "MODAL_HOME";
    WidgetCustomizeEntryPointTypesInput["ModalOther"] = "MODAL_OTHER";
    WidgetCustomizeEntryPointTypesInput["Unknown"] = "UNKNOWN";
})(WidgetCustomizeEntryPointTypesInput = exports.WidgetCustomizeEntryPointTypesInput || (exports.WidgetCustomizeEntryPointTypesInput = {}));
...
(function (WidgetFilterField) {
    ...
    WidgetFilterField["IsVisibleToClients"] = "isVisibleToClients";
...
(function (WidgetSortField) {
    ...
    WidgetSortField["IsVisibleToClients"] = "isVisibleToClients";
