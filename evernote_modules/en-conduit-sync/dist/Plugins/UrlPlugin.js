...
function getUrlPlugin(tokenRefreshManager) {
    ...
    async function noteHistoryUrlResolver(_, args, context) {
        ...
        const noteGuid = en_thrift_connector_1.convertGuidToService(id, en_core_entity_types_1.CoreEntityTypes.Note);
    ...
    async function targetUrlCreateWithOAuthResolver(_, args, context) {
        if (context && context.clientCredentials) {
            ...
            const openIdCredential = {
                ...
                serviceProvider: Auth_1.SERVICE_PROVIDER_STRING_TO_ENUM[args.serviceProvider],
            };
            const userStore = context.comm.getUserStore(`${args.serviceHost}/edam/user`);
