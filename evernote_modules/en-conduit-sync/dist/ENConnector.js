...
function init(di, configs) {
    ...
    const quasarConnector = new en_quasar_connector_1.QuasarConnectorAndExecutor(Object.assign(Object.assign({}, di), { shouldBufferMutation: en_thrift_connector_1.shouldBufferMutation }), hostResolver, nSyncEventManager);
    ...
    const coreEntityPlugin = {
        ...
        entityTypes: () => {
            ...
            result.Note.dataResolver = NoteDataResolver_1.getNoteDataResolver();
            result.Note.deleteHook = en_thrift_connector_1.deletePendingOfflineNoteSyncState;
            result.Workspace.deleteHook = en_thrift_connector_1.WorkspaceConverter.onDelete;
    ...
    return {
        di: {
            ...
            amendSyncContextMetadataBeforeRead: ENSyncEngine_1.fillSyncContextMetadataToken,
            amendSyncContextMetadataBeforeWrite: ENSyncEngine_1.sanitizeSyncContextMetadata,
            ...
            SyncEngine: (graphStorage, ephemeralState, localSettings) => {
                const engine = new ENSyncEngine_1.ENSyncEngine(Object.assign(Object.assign({}, di), { initSyncEventManager,
            ...
            StagedBlobManager: (graphStorage, blobStorage, localSettings) => {
                return new en_thrift_connector_1.ThriftStagedBlobManager(graphStorage, blobStorage, resourceManager, thriftComm, localSettings, offlineContentStrategy, di.handleAuthError, quasarConnector);
            },
            getResourceManager: () => {
            ...
            getMutationServiceLastProcessingTime: async (newTrc, graphStorage) => {
                const timeReturn = await graphStorage.getSyncState(newTrc, null, [en_quasar_connector_1.LAST_NSYNC_SYNC_STATE_PATH]) || 0;
...
//# sourceMappingURL=ENConnector.js.map