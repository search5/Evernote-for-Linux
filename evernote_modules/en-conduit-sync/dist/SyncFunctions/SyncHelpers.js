...
async function getConverterParamsFromSyncParams(trc, graphTransaction, params) {
    return await en_thrift_connector_1.makeConverterParams({
        trc,
        graphTransaction,
