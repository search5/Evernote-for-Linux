...
exports.traverseSchema = exports.validateSchemaValue = exports.validateSchemaType = exports.getSchemaDefaults = exports.getSchemaTypeDefaultValue = exports.fieldTypeOverrideNullability = exports.fieldTypeToCore = exports.fieldTypeToNonNull = exports.NullableEntityRef = exports.NullableTimestamp = exports.NullableInt = exports.NullableNumber = exports.NullableBoolean = exports.NullableUrl = exports.NullableString = exports.NullableID = exports.ListOfStructs = exports.NullableStruct = exports.NullableMapOf = exports.NullableListOf = exports.NullableEnumWithKeys = exports.NullableEnum = exports.ExtendStruct = exports.Struct = exports.MapOf = exports.ListOf = exports.Nullable = exports.EnumWithKeys = exports.Enum = exports.fieldTypeIsBasic = exports.fieldTypeIsStruct = exports.fieldTypeIsMap = exports.fieldTypeIsList = exports.fieldTypeIsNullable = exports.fieldTypeIsEnum = exports.fieldTypeIsCore = void 0;
...
function validateSchemaType(fieldType, path, value, objectStrictCheck = true) {
    ...
    if (fieldTypeIsNullable(fieldType)) {
        ...
        validateSchemaType(fieldType.nullableType, path, value, objectStrictCheck);
        return;
    }
    if (fieldTypeIsList(fieldType)) {
        ...
        for (let i = 0; i < value.length; ++i) {
            validateSchemaType(fieldType.listType, path.concat('.', i.toString()), value[i]);
        }
        return;
    }
    if (fieldTypeIsMap(fieldType)) {
        ...
        for (const key in value) {
            validateSchemaType(mapType, path.concat('.', key), value[key]);
        }
        return;
    }
    if (fieldTypeIsStruct(fieldType)) {
        ...
        for (const key in fieldType.fields) {
            validateSchemaType(fieldType.fields[key], path.concat('.', key), value[key]);
        }
