...
class ElectronNotificationManager extends conduit_core_1.NotificationManager {
    ...
    async schedule(notificationData) {
        ...
        conduit_utils_1.logger.info(`ElectronNotificationsScheduler -- schedule: id: ${convertedNotification.id} `, `-- title: ${convertedNotification.title} `, `-- sendAt: ${notificationData.sendAt} `);
