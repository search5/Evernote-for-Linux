...
function invitationFromAttachment(invitationID, serviceData, sharerID, sentAt) {
    const shareNode = {
        id: invitationID,
        type: en_data_model_1.CoreEntityTypes.Invitation,
        version: 0,
        syncContexts: [],
    ...
    if (serviceData.userId) {
        conduit_storage_1.addOutputEdgeToNode(shareNode, 'owner', {
            id: Converters_1.convertGuidFromService(serviceData.userId, en_data_model_1.CoreEntityTypes.Profile, en_data_model_1.PROFILE_SOURCE.User),
            port: null,
    ...
    if (sharerID) {
        conduit_storage_1.addOutputEdgeToNode(shareNode, 'sharer', {
            id: Converters_1.convertGuidFromService(sharerID, en_data_model_1.CoreEntityTypes.Profile, en_data_model_1.PROFILE_SOURCE.User),
            port: null,
            type: en_data_model_1.CoreEntityTypes.Profile,
        });
    }
...
async function addNewShare(trc, params, syncContext, globalShareID, sharerID, sentAt, serviceData) {
    const invitation = invitationFromAttachment(Converters_1.convertGuidFromService(globalShareID, en_data_model_1.CoreEntityTypes.Invitation), serviceData, sharerID, sentAt);
...
async function addNewIdentity(trc, params, syncContext, serviceData) {
    ...
    if (serviceData.contact) {
        const status = ((_a = serviceData.deactivated) !== null && _a !== void 0 ? _a : false) ? en_data_model_1.ProfileStatusEnum.INACTIVE : en_data_model_1.ProfileStatusEnum.ACTIVE;
