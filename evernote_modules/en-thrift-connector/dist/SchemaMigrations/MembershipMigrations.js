...
async function updateMembershipsWithInvitedTime(trc, graphTransaction, params) {
    ...
    for (let i = 0; i < recipientIsMeMemberships.length; i++) {
        ...
        const acceptedSharedID = Converters_1.convertGuidToService(parentRef.srcID, parentRef.srcType);
        const invitationID = Converters_1.convertGuidFromService(acceptedSharedID, 'Invitation');
