...
exports.setupElectronPrebuiltIPC = exports.fetchPrebuiltDatabase = exports.setDefaultPrebuiltDownloadPath = void 0;
...
function setupElectronPrebuiltIPC(fs) {
    ...
    electron_1.ipcMain.handle(en_conduit_electron_shared_1.ElectronPrebuiltDBChannel, async ({ sender }, message) => {
        const progressCB = (receivedBytes, totalBytes) => {
            const updateMessage = { receivedBytes, totalBytes };
            sender.send(en_conduit_electron_shared_1.ElectronPrebuiltDBChannel, updateMessage);
        };
