...
//
  ...
  module.exports.WorkspaceUserInterfaceLayoutStyle = {
    'LIST' : 0,
    'BOARD' : 1
  };
  ...
  module.exports.SyncChunk = Thrift.Struct.define('SyncChunk',  {
    ...
    19: { alias: 'workspaces', type: Thrift.Type.LIST, def: Thrift.List.define(Thrift.Type.STRUCT, SpaceService.WorkspaceResponse)  },
    ...
    21: { alias: 'prevChunkHighUSN', type: Thrift.Type.I32 }
  });
  ...
  module.exports.SyncChunkFilter = Thrift.Struct.define('SyncChunkFilter',  {
    ...
    25: { alias: 'reverseOrder', type: Thrift.Type.BOOL }
  });
  ...
  module.exports.NoteMetadata = Thrift.Struct.define('NoteMetadata',  {
    ...
    22: { alias: 'score', type: Thrift.Type.DOUBLE }
  });
  ...
  module.exports.NoteResultSpec = Thrift.Struct.define('NoteResultSpec',  {
    ...
    9: { alias: 'pushToNewSync', type: Thrift.Type.BOOL },
    10: { alias: 'includeBlobGuid', type: Thrift.Type.BOOL }
  });
  ...
  module.exports.ManageNotebookSharesResult = Thrift.Struct.define('ManageNotebookSharesResult',  {
    ...
    2: { alias: 'unshareErrors', type: Thrift.Type.LIST, def: Thrift.List.define(Thrift.Type.STRUCT, module.exports.ManageNotebookSharesError)  }
  });
  ...
  module.exports.GetWorkspaceUserInterfacePropertiesRequest = Thrift.Struct.define('GetWorkspaceUserInterfacePropertiesRequest',  {
    1: { alias: 'workspaceGuid', type: Thrift.Type.STRING },
    2: { alias: 'updateVersion', type: Thrift.Type.I32 }
  });

  module.exports.GetWorkspaceUserInterfacePropertiesResponse = Thrift.Struct.define('GetWorkspaceUserInterfacePropertiesResponse',  {
    1: { alias: 'workspaceGuid', type: Thrift.Type.STRING },
    2: { alias: 'updateVersion', type: Thrift.Type.I32 },
    3: { alias: 'layoutStyle', type: Thrift.Type.I32 },
    4: { alias: 'notebookDisplayOrder', type: Thrift.Type.LIST, def: Thrift.List.define(Thrift.Type.STRING)  },
    5: { alias: 'notebookColor', type: Thrift.Type.MAP, def: Thrift.Map.define(Thrift.Type.STRING, Thrift.Type.I32 )  },
    6: { alias: 'noteDisplayOrder', type: Thrift.Type.MAP, def: Thrift.Map.define(Thrift.Type.STRING, Thrift.Type.LIST, Thrift.List.define(Thrift.Type.STRING) )  }
  });
  ...
  NoteStore.getNoteSnippetsV2 = Thrift.Method.define({
    alias: 'getNoteSnippetsV2',
    args: Thrift.Struct.define('getNoteSnippetsV2Args', {
      1: { alias: 'authenticationToken', type: Thrift.Type.STRING, index: 0 },
      2: { alias: 'noteGuids', type: Thrift.Type.LIST, def: Thrift.List.define(Thrift.Type.STRING) , index: 1 },
      3: { alias: 'maxSnippetLength', type: Thrift.Type.I32, index: 2 }
    }),
    result: Thrift.Struct.define('getNoteSnippetsV2Result', {
      0: { alias: 'returnValue',type: Thrift.Type.MAP, def: Thrift.Map.define(Thrift.Type.STRING, Thrift.Type.STRING )  },
      1: { alias: 'userException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMUserException },
      2: { alias: 'systemException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMSystemException }
    })
  ...
  NoteStore.setContentClass = Thrift.Method.define({
    alias: 'setContentClass',
    args: Thrift.Struct.define('setContentClassArgs', {
      1: { alias: 'authenticationToken', type: Thrift.Type.STRING, index: 0 },
      2: { alias: 'noteGuid', type: Thrift.Type.STRING, index: 1 },
      3: { alias: 'contentClass', type: Thrift.Type.STRING, index: 2 }
    }),
    result: Thrift.Struct.define('setContentClassResult', {
      0: { alias: 'returnValue',type: Thrift.Type.STRUCT, def: Types.Note },
      1: { alias: 'userException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMUserException },
      2: { alias: 'systemException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMSystemException },
      3: { alias: 'notFoundException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMNotFoundException }
  ...
  NoteStore.getOrCreateLinkedNotebook = Thrift.Method.define({
    alias: 'getOrCreateLinkedNotebook',
    args: Thrift.Struct.define('getOrCreateLinkedNotebookArgs', {
      1: { alias: 'authenticationToken', type: Thrift.Type.STRING, index: 0 },
      2: { alias: 'linkedNotebook', type: Thrift.Type.STRUCT, def: Types.LinkedNotebook, index: 1 }
    }),
    result: Thrift.Struct.define('getOrCreateLinkedNotebookResult', {
      0: { alias: 'returnValue',type: Thrift.Type.STRUCT, def: Types.LinkedNotebook },
      1: { alias: 'userException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMUserException },
      2: { alias: 'notFoundException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMNotFoundException },
      3: { alias: 'systemException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMSystemException }
  ...
  NoteStore.createWorkspace = Thrift.Method.define({
  ...
  NoteStore.getWorkspace = Thrift.Method.define({
    alias: 'getWorkspace',
  ...
  NoteStore.listWorkspaces = Thrift.Method.define({
  ...
  NoteStore.updateWorkspace = Thrift.Method.define({
  ...
  NoteStore.manageWorkspaceSharing = Thrift.Method.define({
  ...
  NoteStore.joinWorkspace = Thrift.Method.define({
    alias: 'joinWorkspace',
  ...
  NoteStore.leaveWorkspace = Thrift.Method.define({
  ...
  NoteStore.getWorkspaceUserInterfaceProperties = Thrift.Method.define({
    alias: 'getWorkspaceUserInterfaceProperties',
    args: Thrift.Struct.define('getWorkspaceUserInterfacePropertiesArgs', {
      1: { alias: 'authentiationToken', type: Thrift.Type.STRING, index: 0 },
      2: { alias: 'request', type: Thrift.Type.STRUCT, def: module.exports.GetWorkspaceUserInterfacePropertiesRequest, index: 1 }
    }),
    result: Thrift.Struct.define('getWorkspaceUserInterfacePropertiesResult', {
      0: { alias: 'returnValue',type: Thrift.Type.STRUCT, def: module.exports.GetWorkspaceUserInterfacePropertiesResponse },
      1: { alias: 'systemException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMSystemException },
      2: { alias: 'userException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMUserException },
      3: { alias: 'notFoundException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMNotFoundException }
    })
  ...
  NoteStore.setWorkspaceUserInterfaceLayoutStyle = Thrift.Method.define({
    alias: 'setWorkspaceUserInterfaceLayoutStyle',
    args: Thrift.Struct.define('setWorkspaceUserInterfaceLayoutStyleArgs', {
      1: { alias: 'authentiationToken', type: Thrift.Type.STRING, index: 0 },
      2: { alias: 'workspaceGuid', type: Thrift.Type.STRING, index: 1 },
      3: { alias: 'layoutStyle', type: Thrift.Type.I32, index: 2 }
    }),
    result: Thrift.Struct.define('setWorkspaceUserInterfaceLayoutStyleResult', {
      1: { alias: 'systemException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMSystemException },
      2: { alias: 'userException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMUserException },
      3: { alias: 'notFoundException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMNotFoundException }
    })
  ...
  NoteStore.setNotebookUserInterfaceDisplayOrder = Thrift.Method.define({
    alias: 'setNotebookUserInterfaceDisplayOrder',
    args: Thrift.Struct.define('setNotebookUserInterfaceDisplayOrderArgs', {
      1: { alias: 'authentiationToken', type: Thrift.Type.STRING, index: 0 },
      2: { alias: 'workspaceGuid', type: Thrift.Type.STRING, index: 1 },
      3: { alias: 'notebookDisplayOrder', type: Thrift.Type.LIST, def: Thrift.List.define(Thrift.Type.STRING) , index: 2 }
    }),
    result: Thrift.Struct.define('setNotebookUserInterfaceDisplayOrderResult', {
      1: { alias: 'systemException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMSystemException },
      2: { alias: 'userException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMUserException },
      3: { alias: 'notFoundException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMNotFoundException }
    })
  ...
  NoteStore.setNotebookUserInterfaceColors = Thrift.Method.define({
    alias: 'setNotebookUserInterfaceColors',
    args: Thrift.Struct.define('setNotebookUserInterfaceColorsArgs', {
      1: { alias: 'authenticationToken', type: Thrift.Type.STRING, index: 0 },
      2: { alias: 'workspaceGuid', type: Thrift.Type.STRING, index: 1 },
      3: { alias: 'updatedColors', type: Thrift.Type.MAP, def: Thrift.Map.define(Thrift.Type.STRING, Thrift.Type.I32 ) , index: 2 }
    }),
    result: Thrift.Struct.define('setNotebookUserInterfaceColorsResult', {
      1: { alias: 'systemException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMSystemException },
      2: { alias: 'userException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMUserException },
      3: { alias: 'notFoundException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMNotFoundException }
    })
  ...
  NoteStore.setNoteUserInterfaceDisplayOrder = Thrift.Method.define({
    alias: 'setNoteUserInterfaceDisplayOrder',
    args: Thrift.Struct.define('setNoteUserInterfaceDisplayOrderArgs', {
      1: { alias: 'authenticationToken', type: Thrift.Type.STRING, index: 0 },
      2: { alias: 'workspaceGuid', type: Thrift.Type.STRING, index: 1 },
      3: { alias: 'noteDisplayOrder', type: Thrift.Type.MAP, def: Thrift.Map.define(Thrift.Type.STRING, Thrift.Type.LIST, Thrift.List.define(Thrift.Type.STRING) ) , index: 2 }
    }),
    result: Thrift.Struct.define('setNoteUserInterfaceDisplayOrderResult', {
      1: { alias: 'systemException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMSystemException },
      2: { alias: 'userException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMUserException },
      3: { alias: 'notFoundException', type: Thrift.Type.EXCEPTION, def: Errors.EDAMNotFoundException }
    })
  ...
  NoteStoreClient.prototype.getNoteSnippetsV2 = function(authenticationToken, noteGuids, maxSnippetLength, callback) {
    var mdef = NoteStore.getNoteSnippetsV2;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
    args.noteGuids = noteGuids;
    args.maxSnippetLength = maxSnippetLength;
  ...
  NoteStoreClient.prototype.setContentClass = function(authenticationToken, noteGuid, contentClass, callback) {
    var mdef = NoteStore.setContentClass;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
  ...
  NoteStoreClient.prototype.getOrCreateLinkedNotebook = function(authenticationToken, linkedNotebook, callback) {
    var mdef = NoteStore.getOrCreateLinkedNotebook;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
    args.linkedNotebook = linkedNotebook;
    mdef.sendRequest(this.output, this.seqid++, args, callback);
  ...
  NoteStoreClient.prototype.createWorkspace = function(authenticationToken, workspace, spec, callback) {
    var mdef = NoteStore.createWorkspace;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
  ...
  NoteStoreClient.prototype.getWorkspace = function(authenticationToken, workspaceGuid, responseSpec, callback) {
    var mdef = NoteStore.getWorkspace;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
  ...
  NoteStoreClient.prototype.listWorkspaces = function(authenticationToken, workspaceResponseSpec, filter, callback) {
    var mdef = NoteStore.listWorkspaces;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
  ...
  NoteStoreClient.prototype.updateWorkspace = function(authenticationToken, workspace, callback) {
    var mdef = NoteStore.updateWorkspace;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
    args.workspace = workspace;
    mdef.sendRequest(this.output, this.seqid++, args, callback);
  ...
  NoteStoreClient.prototype.manageWorkspaceSharing = function(authenticationToken, request, callback) {
    var mdef = NoteStore.manageWorkspaceSharing;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
    args.request = request;
    mdef.sendRequest(this.output, this.seqid++, args, callback);
  ...
  NoteStoreClient.prototype.joinWorkspace = function(authenticationToken, workspaceGuid, callback) {
    var mdef = NoteStore.joinWorkspace;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
    args.workspaceGuid = workspaceGuid;
    mdef.sendRequest(this.output, this.seqid++, args, callback);
  ...
  NoteStoreClient.prototype.leaveWorkspace = function(authenticationToken, workspaceGuid, callback) {
    var mdef = NoteStore.leaveWorkspace;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
    args.workspaceGuid = workspaceGuid;
    mdef.sendRequest(this.output, this.seqid++, args, callback);
  ...
  NoteStoreClient.prototype.getWorkspaceUserInterfaceProperties = function(authentiationToken, request, callback) {
    var mdef = NoteStore.getWorkspaceUserInterfaceProperties;
    var args = new mdef.args();
    args.authentiationToken = authentiationToken;
    args.request = request;
    mdef.sendRequest(this.output, this.seqid++, args, callback);
  };

  NoteStoreClient.prototype.setWorkspaceUserInterfaceLayoutStyle = function(authentiationToken, workspaceGuid, layoutStyle, callback) {
    var mdef = NoteStore.setWorkspaceUserInterfaceLayoutStyle;
    var args = new mdef.args();
    args.authentiationToken = authentiationToken;
    args.workspaceGuid = workspaceGuid;
    args.layoutStyle = layoutStyle;
    mdef.sendRequest(this.output, this.seqid++, args, callback);
  };

  NoteStoreClient.prototype.setNotebookUserInterfaceDisplayOrder = function(authentiationToken, workspaceGuid, notebookDisplayOrder, callback) {
    var mdef = NoteStore.setNotebookUserInterfaceDisplayOrder;
    var args = new mdef.args();
    args.authentiationToken = authentiationToken;
    args.workspaceGuid = workspaceGuid;
    args.notebookDisplayOrder = notebookDisplayOrder;
    mdef.sendRequest(this.output, this.seqid++, args, callback);
  };

  NoteStoreClient.prototype.setNotebookUserInterfaceColors = function(authenticationToken, workspaceGuid, updatedColors, callback) {
    var mdef = NoteStore.setNotebookUserInterfaceColors;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
    args.workspaceGuid = workspaceGuid;
    args.updatedColors = updatedColors;
    mdef.sendRequest(this.output, this.seqid++, args, callback);
  };

  NoteStoreClient.prototype.setNoteUserInterfaceDisplayOrder = function(authenticationToken, workspaceGuid, noteDisplayOrder, callback) {
    var mdef = NoteStore.setNoteUserInterfaceDisplayOrder;
    var args = new mdef.args();
    args.authenticationToken = authenticationToken;
    args.workspaceGuid = workspaceGuid;
    args.noteDisplayOrder = noteDisplayOrder;
    mdef.sendRequest(this.output, this.seqid++, args, callback);
  };
