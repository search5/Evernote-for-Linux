...
exports.notificationManagerSNUtilityDI = {
    ...
    getScheduledNotifications: async (trc, graphDB) => {
        ...
        const scheduledNotifications = await graphDB.getGraphNodesByType(trc, null, en_conduit_plugin_scheduled_notification_shared_1.ScheduledNotificationEntityTypes.ScheduledNotification);
