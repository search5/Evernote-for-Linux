...
function ceDataForTemplatesPlugin(thriftComm) {
    async function ceDataForTemplates(parent, args, context) {
        ...
        return {
            noteGuid: en_thrift_connector_1.convertGuidToService(args.noteID, en_data_model_1.CoreEntityTypes.Note),
...
exports.ceDataForTemplatesPlugin = ceDataForTemplatesPlugin;
