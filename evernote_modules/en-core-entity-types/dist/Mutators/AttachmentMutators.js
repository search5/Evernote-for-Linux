...
exports.attachmentSetApplicationDataEntry = exports.attachmentSetFileName = exports.attachmentCreateInternal = void 0;
...
exports.attachmentCreateInternal = {
    ...
    execute: async (trc, ctx, params) => {
        ...
        plan.results.result = await AttachmentMutatorHelpers_1.genAttachmentCreateOps(trc, ctx, data, plan, noteRef, noteRef, false, false);
        return plan;
    },
};
...
exports.attachmentSetApplicationDataEntry = {
    ...
    executeOnService: async (trc, ctx, params) => {
        ...
        const attachment = await ctx.fetchEntity(trc, nodeRef);
        if (!attachment) {
            throw new conduit_utils_1.NotFoundError(params.id, 'Missing attachment to set application data');
        }
        return {
            command: 'attachmentSetAppData',
            nodeType: EntityConstants_1.CoreEntityTypes.Attachment,
            params,
            owner: nodeRef,
        };
    },
