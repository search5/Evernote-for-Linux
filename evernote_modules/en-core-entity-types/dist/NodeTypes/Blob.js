...
exports.BlobCache = exports.BlobV2SchemaWithContent = exports.BlobV2Schema = exports.BlobSchema = exports.BlobBaseSchema = void 0;
exports.BlobBaseSchema = {
    localChangeTimestamp: 'timestamp',
    hash: 'string',
    size: 'number',
};
exports.BlobSchema = Object.assign(Object.assign({}, exports.BlobBaseSchema), { url: 'url?' });
