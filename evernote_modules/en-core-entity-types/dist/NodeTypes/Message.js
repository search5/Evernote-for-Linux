...
exports.messageIndexConfig = exports.messageTypeDef = exports.WORKCHAT_MESSAGE_BODY_LEN_MAX = void 0;
const conduit_storage_1 = require("conduit-storage");
const EntityConstants_1 = require("../EntityConstants");
exports.WORKCHAT_MESSAGE_BODY_LEN_MAX = 2048;
const messageBodyWrapperLen = '<msg></msg>'.length; // We need to substract wrapper length.
exports.messageTypeDef = {
    ...
    fieldValidation: {
        label: {
            min: 1,
            max: exports.WORKCHAT_MESSAGE_BODY_LEN_MAX - messageBodyWrapperLen,
            debugName: 'message',
        },
    },
    schema: {
